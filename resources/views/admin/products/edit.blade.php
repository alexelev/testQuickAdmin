...
<div class="form-group">
    ...
    {!! Form::label('photo', 'Изображение', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::file('photo') !!}
    ...
    {!! Form::label('isActive', 'Активный?', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::hidden('isActive','') !!}
        {!! Form::checkbox('isActive', 1, $products->isActive == 1) !!}
    ...
    {!! Form::label('categories_id', 'Категория', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
